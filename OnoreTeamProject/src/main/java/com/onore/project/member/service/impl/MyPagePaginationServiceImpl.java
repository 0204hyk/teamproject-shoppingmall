...
@Service
public class MyPagePaginationServiceImpl implements MyPagePaginationService {
	...
	@Override
	public void qnaPage(HttpServletRequest req, String mem_id) {
		String pageStr = req.getParameter("qnaPage");
		HttpSession se = req.getSession();
		String id = ((MemberDTO)se.getAttribute("signIn")).getMem_id();
		mem_id = id;
		List<QnaDTO> pages = member_mapper.getQnaView(mem_id);
