const receiver_address_btn = document.getElementById('receiver_address_btn');
        ...
        new daum.Postcode({
            oncomplete: function(data) {
                ...
                if(data.userSelectedType === 'R'){
                    ...
                    receiver_detail_address.value = extraAddr;
                
                } else {
                    receiver_detail_address.value = '';
                }

                // 우편번호와 주소 정보를 해당 필드에 넣는다.
                receiver_zip_code.value = data.zonecode;
                receiver_address.value = addr;
                // 커서를 상세주소 필드로 이동한다.
                receiver_detail_address.focus();
            }
        }).open();
});
