						...
						<c:forEach items="${reviewList}" var="review">
							<tr>
								...
								<c:choose>
									...
									<c:otherwise>							
										<td style="width: 200px;"><img src="<%=request.getContextPath()%>/resources/review/image/${review.review_img_1}" alt="이미지 미리보기" style="width: 100px; height: 100px; border-radius: 10px;"/></td>
									</c:otherwise>
								</c:choose>
