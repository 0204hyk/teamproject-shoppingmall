...
<div class="middle_member_info_delete_div">
	<form id="member_info_delete_form" action="<%=request.getContextPath() %>/memberDelete.do" method="POST" name="member_info_delete_form">
		<div class="member_info_delete_div">
			...
			<div class="member_delete_id_div">
				...
				<div class="delete_input_div">
					<input class="mem_id" id="mem_id" type="text" name="mem_id" value="${signIn.mem_id}" readonly>
				</div>
			</div>
			...
			<div class="delete_pw_div">
				...
				<div class="delete_input_div">
					<input id="mem_pw" type="password" name="mem_pw" placeholder="비밀번호를 입력하세요." required>
				</div>
			</div>
				<div class="delete_message_div">
					<p id="delete_pw_message_p">${message}</p>
				</div>
			
			<article>
				<div class="member_delete_Btn_div">
				  <input class="member_delete_Btn" type="submit" value="탈퇴하기">
				  <div class="mypage_go_btn_div">
