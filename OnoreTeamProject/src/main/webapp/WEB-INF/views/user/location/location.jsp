...
<div class="middle_location_div">
	...
	<div class="map_div">
		<div class="location_map_div1">
			<div id="location_map_div2"></div>
		</div>
		
		<div class="location_content_div1">
			<div class="location_content_div2">
			<script src="//dapi.kakao.com/v2/maps/sdk.js?appkey=75e78a8a9cdd102b783fb3c5f36e1da5"></script>
			<script>
				// 지도 띄우기
				...
				kakao.maps.event.addListener(marker, 'click', function() {
					...
					var end = new kakao.maps.LatLng(37.605099, 127.14046);
